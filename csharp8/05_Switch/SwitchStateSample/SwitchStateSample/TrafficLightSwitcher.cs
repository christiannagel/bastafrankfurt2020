...
namespace SwitchStateSample
{
    public class TrafficLightSwitcher
    {
        ...
        public LightStatus GetNextLight4(LightStatus lightStatus)
            => lightStatus switch
            {
                { Current: FlashingYellow } 
                  => new LightStatus(Red, FlashingYellow, 5000),
                { Current: Red } 
                  => new LightStatus(Yellow, lightStatus.Current, 3000),
                ...
                { Current: FlashingGreen }                   
                  => new LightStatus(FlashingGreen, lightStatus.Current, 1000, lightStatus.FlashCount + 1),
